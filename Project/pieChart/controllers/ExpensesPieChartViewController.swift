...
class ExpensesPieChartViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        Totals.shared.getTotalDayExpenses(callback: { [weak self](sum) in
            
            self?.totalSum = sum
            PieChartDataSource.shared.exspensesData(totalSum: sum, numberOfData: self!.numberOfData, pieChart: self!.pieChart,index:0, chosenDate: self!.date)
    ...
    func setArrowsPie(Minus:Bool){
        ...
        case 0:
            ...
            Totals.shared.getTotalDayExpenses(callback: { [weak self](sum) in
                self?.totalSum = sum
                PieChartDataSource.shared.exspensesData(totalSum: sum, numberOfData: self!.numberOfData, pieChart: self!.pieChart,index:self!.index, chosenDate: self!.date)
        ...
        case 1:
            ...
            Totals.shared.getTotalWeekExpenses(callback: { [weak self](sum) in
                self?.totalSum = sum
                PieChartDataSource.shared.exspensesData(totalSum: sum, numberOfData: self!.numberOfData, pieChart: self!.pieChart,index:self!.index, chosenDate: self!.date)
        ...
        case 2:
            ...
            Totals.shared.getTotalMonthExpenses(callback: { [weak self](sum) in
                self?.totalSum = sum
                PieChartDataSource.shared.exspensesData(totalSum: sum, numberOfData: self!.numberOfData, pieChart: self!.pieChart,index:self!.index, chosenDate: self!.date)
        ...
        case 3:
            ...
            Totals.shared.getTotalYearExpenses(callback: { [weak self](sum) in
                self?.totalSum = sum
                PieChartDataSource.shared.exspensesData(totalSum: sum, numberOfData: self!.numberOfData, pieChart: self!.pieChart,index:self!.index, chosenDate: self!.date)
...
extension ExpensesPieChartViewController:ScreenMode{}
