//
//  ExpensesBarChartViewController.swift
//  Project
//
...
class ExpensesBarChartViewController: UIViewController,ChartViewDelegate{
    ...
    func getData(){
        ...
        for i in 0..<weekDays.count{
            BarChartDataSource.shared.getExpenseForSpesificDay(
...
extension ExpensesBarChartViewController:ScreenMode{}
