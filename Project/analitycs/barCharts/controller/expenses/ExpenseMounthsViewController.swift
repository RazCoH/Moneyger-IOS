//
//  ExpenseMounthsViewController.swift
//  Project
//
...
class ExpenseMounthsViewController: UIViewController,ChartViewDelegate {
    ...
    func getDataTest(){
        for i in 0..<m.count{
            BarChartDataSource.shared.getExpenseForSpesificMonth(callback: {[weak self] (sum) in
...
extension ExpenseMounthsViewController:ScreenMode{}
